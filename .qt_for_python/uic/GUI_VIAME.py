...
################################################################################
## Form generated from reading UI file 'GUI_VIAME.ui'
##
...
"}")
        ...
        self.frame_top_btns.setStyleSheet(u"background-color: rgba(39, 39, 39, 255)")
...
"}")
        ...
        self.frame_top_info.setStyleSheet(u"background-color: rgb(26, 26, 26);")
...
"}")
        ...
        self.frame_content_right.setStyleSheet(u"background-color: rgb(18, 18, 18);")
        ...
        self.page_viewports = QWidget()
        self.page_viewports.setObjectName(u"page_viewports")
        self.gridLayoutWidget = QWidget(self.page_viewports)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(9, 9, 871, 581))
        self.layout_viewport = QGridLayout(self.gridLayoutWidget)
        self.layout_viewport.setObjectName(u"layout_viewport")
        self.layout_viewport.setContentsMargins(0, 0, 0, 0)
        self.stackedWidget.addWidget(self.page_viewports)
        self.page_table = QWidget()
        self.page_table.setObjectName(u"page_table")
        self.verticalLayout_6 = QVBoxLayout(self.page_table)
...
"}")
        ...
        self.frame_3 = QFrame(self.page_table)
...
"")
        ...
        self.frame_grip.setStyleSheet(u"background-color: rgb(30, 30, 30);")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"VIAME Engine", None))
        self.label.setText("")
        ...
        self.label_credits.setText(QCoreApplication.translate("MainWindow", u"Status: Ready", None))
