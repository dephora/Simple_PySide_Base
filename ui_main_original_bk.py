...
from qgis.PyQt.QtCore import Qt, QRectF, QSize, QMetaObject, QCoreApplication, QRect
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layout_viewport = QGridLayout()
        self.layout_viewport.setObjectName(u"layout_viewport")

        # self.gridLayout_2.addWidget(self.scrollArea, 0, 5, 3, 1)
        self.viewport = MapCanvasWidget()
        # self.gridLayout_2.addWidget(self.viewport, 0, 5, 3, 1)
        self.layout_viewport.addWidget(self.viewport)

        # Create a test layer
        self.vlayer = create_test_layer()
        self.vlayer.updateExtents()

        # Create canvas widget and add layer
        self.viewport.add_layer(self.vlayer)
        self.viewport.show()
